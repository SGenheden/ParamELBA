...
"""
Routines to help with colors and style in plotting
"""
...
def style(idx) :
  """
  Returns the style of index

  For instances when the index is larger than the number of defined styles,
  this routine takes care of this by periodicity, i.e.
  style at idx=0 is the same style as idx=n 
